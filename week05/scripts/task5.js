...
// fetch(url).then(res => res.json()).then(temples => {})

// Step 6: Inside of second .then() method, assign the list of temples (as a JSON object) to the temples variable
// fetch(url).then(res => res.json()).then(temples => const templeList = temples)
...
const reset = () => (document.getElementById('temples').innerHTML = '')
